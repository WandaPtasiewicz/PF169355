...
class TestMovie(unittest.TestCase):
    ...
    def setUp(self):
        self.valid_movie = Movie(2, "Rambo", "Adam Nowak",
                                 2000, MovieGenre.ACTION,
                                 10)
    ...
    def test_creation_positive(self):
        movie1 = Movie(1, "Indiana Jones", "John Bon",
    ...
    def test_error_creation_old_release_year(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, "Indiana Jones", "John Bon", 2,
    ...
    def test_error_too_old_release_year(self):
        ...
        self.assertEqual(str(context.exception),
                         "Invalid release year: 2")

    def test_error_creation_not_int_release_year(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, "Indiana Jones", "John Bon",
                  "dwa", MovieGenre.ACTION, 12)
        self.assertEqual(str(context.exception),
    ...
    def test_creation_error_genre(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, "Indiana Jones", "John Bon", 2000,
                  "fajny", 12)
    ...
    def test_creation_error_title_null(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, "", "John Bon", 2000,
                  MovieGenre.FANTASY, 2)
        self.assertEqual(str(context.exception),
    ...
    def test_creation_error_title_not_string(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, 4.12, "John Bon",
                           2000, MovieGenre.FANTASY, 2)
        self.assertEqual(str(context.exception),
                         "Title must be a non-empty string")
    ...
    def test_creation_direction_title_not_capital(self):
        with self.assertRaises(ValueError) as context:
            Movie(1, "Jsiem", "viki", 2000,
                  MovieGenre.FANTASY, 2)
        self.assertEqual(str(context.exception),
                         "Director must start with capital letter")
    ...
    def test_error_too_young_to_rent_movie(self):
        ...
        adult_movie = Movie(3, "Krwawa masakra", "John Miller",
                            2002, MovieGenre.HORROR, 18)
